...
[_BL] = KEYMAP_ANSI( // base layer: colemak with middle parenthesis mod
  ...
  KC_LSFT		 ,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,KC_SLSH,KC_K	 ,KC_M   ,KC_COMM,KC_DOT ,KC_BSLS	  ,\
  KC_LCTL,KC_LGUI,MO(_FL),   		KC_SPC,                            LCTL(KC_C),LCTL(KC_V),TG(_NL),TG(_QL)),

[_FL] = KEYMAP_ANSI( // function layer
  KC_GRV ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F4   ,KC_F5  ,KC_F6  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10  ,KC_F11 ,KC_F12 ,RESET,  \
  _______,_______,_______,KC_UP  ,_______ ,_______,KC_LPRN,_______,_______,KC_UP  ,KC_HOME ,KC_END ,BL_INC ,KC_DEL, \
  _______,KC_LALT,KC_LEFT,KC_DOWN,KC_RIGHT,_______,KC_RPRN,_______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______, \
  _______,_______,_______,_______,_______ ,_______,_______,KC_MINS,KC_EQL ,KC_PGUP,KC_PGDN ,_______,
  _______,_______,_______,                 _______,                                LCTL(LSFT(KC_C)),LCTL(LSFT(KC_V)),_______,_______),
